          ...
          <Fade bottom distance={"4rem"}>
            <div className="flex flex-col gap-14">
              ...
              <div className="relative">
                <textarea
                  id="message"
                  className="block w-full h-auto min-h-[10rem] max-h-[20rem] py-2 px-4 text-xl sm:text-2xl font-mono outline-none border-2 border-purple bg-transparent rounded-[0.6rem] transition-all duration-200"
